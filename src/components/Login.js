...
const Login = () => {
      ...
      createUserWithEmailAndPassword(
        ...
        .then((userCredential) => {
          ...
          updateProfile(user, {
            ...
            photoURL: "https://avatars.githubusercontent.com/u/105659165?v=4",
          })
            .then(() => {
              // Profile updated!
  ...
  return (
    <div>
      ...
      <form className="absolute w-3/12 bg-black my-36 mx-auto right-0 left-0 text-white p-12 rounded-lg opacity-[0.85]">
